...
@php
    ...
    $hiddenCustomers=$customers?->map(function($plan){
                                ...
                                <td>
                                    <form method="POST" action="{{ route('hide-customer-state', $hiddenCustomer->id) }}">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" onclick="return confirm('Are you sure you want to unhide this user from the list?')" class="focus:outline-none text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium text-sm p-2">
