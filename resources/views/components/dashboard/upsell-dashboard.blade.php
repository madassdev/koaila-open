@props(['upsellStats','upsell', 'customersByPlans', 'saleFunnelData'])
...
<div class="bg-white rounded mt-4" id="upsell-table">
    <div class="p-4">
            ...
            <div class="p-4 text-right">
                <div class="flex justify-end items-center">
                    <a href="{{route('upsell-download', ['type'=>'visible'])}}"
                       target="_blank" class="py-2.5 px-5 inline-flex items-center space-x-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200" v-track.upsell_user_list_download_click>
        ...
        <customer-upsell-list-by-plan :data='{!!json_encode($customersByPlans)!!}' :sale-funnel-data="{{json_encode($saleFunnelData)}}">
