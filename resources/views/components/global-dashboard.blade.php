        ...
        <div class="bg-white rounded mt-4">
            <div class="p-4">
                ...
                <div class="flex justify-end">
                    <button onclick="document.getElementById('featureAddoptionModal').hidden=false; body.style.overflow = 'hidden';" class="text-blue-600 hover:text-blue-700" >See more</button>
                </div>
                <div id="featureAddoptionModal" hidden onclick="document.getElementById('featureAddoptionModal').hidden=true; body.style.overflow = 'auto'" class="fixed inset-0 bg-white bg-opacity-50 overflow-y-auto h-full w-full">
                    <div class="relative top-20 mx-auto p-5 border shadow-lg rounded-md bg-white w-1/2">
                        <div class="flex justify-end">
                            <button onclick="document.getElementById('featureAddoptionModal').hidden=true; body.style.overflow = 'auto'" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded">Close</button>
                        </div>
                        <h1 class="text-lg font-semibold text-gray-900 mb-4 text-center">Feature adoption (%)</h1>
                        <bar-chart
                            :data= '{!!json_encode($featureAdoption->data)!!}'
