                    ...
                    <div class="bg-white rounded mt-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="p-4 text-left bg-white dark:text-white dark:bg-gray-800">
                                ...
                                <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">List of users to upsell with the reason we believe they might convert! 
                                <br/>The column of this table are the most common events among users who were previously upsold.</p>
                            </div>
                            <div class="p-4 text-right">
                                <div class="flex justify-end items-center">
                                <a href="{{URL('/results/'.Auth::user()->results->firstWhere('type','upsell')->filename)}}" target="_blank" class="bg-blue-700 hover:bg-blue-800 text-white font-bold p-3 rounded">
